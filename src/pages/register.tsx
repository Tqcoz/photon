                    ...
                    <div className="flex flex-col rounded-md shadow-lg w-96 border-box">
                        <div className="hero modal-top">
                            <div className="rounded-md m-2 p-2 flex flex-row items-center h-8 bg-gray-600 bg-opacity-5">
                                <a className="text-gray-200 font-medium text-xl hover:underline model-trans text-center rounded-md flex-1" href="/login">Login</a>
                                <h1 className="font-bold text-xl text-center text-gray-100 rounded-md flex-1 cursor-default">Register</h1>
                            </div>
                        </div>
